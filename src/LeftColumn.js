...
const svgPlanned = (
  ...
  >
    <g id="Layer_1">
      ...
      <path
        id="svg_2"
        d="m15.56286,4.83634c-0.34117,0 -0.61633,0.22488 
    ...
    7.11525,2.59665 7.11525,5.78963c0,3.19298 -3.19209,5.78913 -7.11525,5.78913z"
        stroke="#000"
        fill="#000000"
      />
    </g>
...
const importantTaskSvg = (
  ...
  >
    <g id="Layer_1">
      ...
      <path
        id="svg_1"
        d="m14.44643,2.9366l2.15347,3.9937l-0.88796,0.47132l2.71163,
    3.42172l-0.88757,0.57144l3.35215,5.72985l-5.68584,-4.39099l1.08449,-0.60979l-3.53276,
    -2.81247l1.26591,-0.86914l-3.73009,-2.9504l4.15657,-2.55524z"
        stroke="#000"
        fill="#000000"
      />
    </g>
...
const toDayTaskSvg = (
  <svg width="30" height="20" xmlns="http://www.w3.org/2000/svg">
    <g id="Layer_1">
      ...
      <path
        id="svg_2"
        d="m24.42236,9.39357l-2.4026,-1.75162l0,-4.1834l-2.05971,0l0,2.68177l-4.80598,-3.5038l-9.26829,
    6.75705l2.20644,-0.03833l0,6.83141l14.02563,0l0,-6.79309l2.30452,0zm-9.26829,5.81603l-4.57687,0l0,-4.00435l4.57687,
    0l0,4.00435zm4.44661,-1.71615l-3.00757,0l0,-2.31222l3.00757,0l0,2.31222z"
        stroke="#000"
        fill="#000000"
      />
      <path
        id="svg_3"
        d="m39.11664,14.39829l-0.01531,-0.01531l0,-0.03657l-0.01313,0l0,0.02344l-0.03063,-0.03063l-0.05906,
    0.05906l0.01406,-0.00034l0,0.05971l0.08938,0l0,-0.05938l0.01469,0zm-0.05906,0.05084l-0.02917,0l0,-0.035l0.02917,0l0,
    0.035zm0.02834,-0.015l-0.01917,0l0,-0.02021l0.01917,0l0,0.02021z"
        stroke="#000"
        fill="#000000"
      />
    </g>
...
const allTasksSvg = (
  <svg width="30" height="20" xmlns="http://www.w3.org/2000/svg">
    <g id="Layer_1">
      ...
      <path
        id="svg_1"
        d="m9.03921,13.40213l13.15319,0.0045l-0.42682,0.56532l-12.29451,-0.0135l-0.43186,-0.55632l0,0zm0.09039,
    ...
    -2.75193,-7.51951 -6.13465,-7.51951z"
        stroke="#000"
        fill="#000000"
      />
    </g>
    ...
    return (
      <div className="leftColumn">
        ...
        <div className="leftColumnCenter">
          <div onClick={handleTodayTask} className="leftColumnElemWrapper">
            <LeftColumnElem
              svg={toDayTaskSvg}
          ...
          <div onClick={handleImportantTask} className="leftColumnElemWrapper">
            <LeftColumnElem
              svg={importantTaskSvg}
              name={"Важные задачи"}
              count={importantTaskCount}
            />
          </div>

          <div onClick={handlePlanedTask} className="leftColumnElemWrapper">
            <LeftColumnElem
              svg={svgPlanned}
          ...
          <div onClick={handleAllTask} className="leftColumnElemWrapper">
            <LeftColumnElem
              svg={allTasksSvg}
              name={"Все задачи"}
              count={allTaskCount}
